	...
	<div :class="`player --${direction}`">
		...
		<div class="stats-wrapper">
			<div :class="[`stats --${direction}`, { '--active': freezetime }]">
				...
				<div class="values">
					<div :class="['value', { '--green': player.match_stats.kills > player.match_stats.deaths*1.5 }]">
					...
					<div :class="['value', { '--red': player.match_stats.kills*1.5 < player.match_stats.deaths }]">
